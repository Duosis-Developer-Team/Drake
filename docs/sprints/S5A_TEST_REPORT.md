...
| Python unit | `uv run pytest -m "not integration" -q` | 258 passed | PASS |
| Python integration | `uv run pytest -m integration -q` | 122 passed | PASS |
...
**Two consecutive full-chain runs: 49/49 passed, both times** (2.6 min
